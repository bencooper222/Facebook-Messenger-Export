...
/// Creds to https://stackoverflow.com/questions/268321/bidirectional-1-to-1-dictionary-in-c-sharp
/// </summary>
...
public class BiDictionaryOneToOne<TFirst, TSecond>
{
    ...
    /// <summary>
    /// Get the list of the first set keys
    /// </summary>
    ...
    /// <summary>
    /// Gets the list off the second set keys
    /// </summary>
